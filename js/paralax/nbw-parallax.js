...
$(document).ready(function() { //when the document is ready...
	...
	$('#space1, #space2, #space3, #space4').bind('inview', function (event, visible) {
			if (visible == true) {
	...
	*/
	...
	function Move(){ 
		...
		if($secondBG.hasClass("inview")){
			//call the newPos function and change the background position
			$secondBG.css({'backgroundPosition': newPos(0, windowHeight, pos, 2000, 0)});
		...
		if ($thirdBG.hasClass("inview")){
			...
			//$secondBG.css({'backgroundPosition': newPos(50, windowHeight, pos, 1550, 0.3)});
			bg3.css({'backgroundPosition': newPos(50, windowHeight, pos, 4410, 0.2)});
			//call the newPos function and change the second background position
		}
		
		if ($fourthBG.hasClass("inview")){
			//call the newPos function and change the background position
			$fourthBG.css({'backgroundPosition': newPos(0, windowHeight, pos, 5000, 0)});
			//$secondBG.css({'backgroundPosition': newPos(50, windowHeight, pos, 1550, 0.3)});
			//call the newPos function and change the second background position
